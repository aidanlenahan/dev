...
//B4
//10.18.23
//this program will take all floats and either add, subtract, multiply, or divide based on user input, but contradicting to calc2,
//this will take characters such as +, -, *, /, and "e"/"E" for operations instead of taking integers which corresponded to specific operations
